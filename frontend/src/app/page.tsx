    ...
    <>
      ...
      <main className='flex flex-col'>
        <section className='font-sans h-[91vh] bg-gray-900 flex flex-col items-center justify-items-center sm:p-18 rounded-b-[20px]'>
          <h2 className='text-center text-[1.5rem] font-bold mt-4 ml-2 mr-2 text-white'>
        ...
        <section className='w-full h-[100vh] flex flex-col bg-white'></section>
      </main>
          ...
          <div className='md:flex md:justify-between'>
            ...
            <div className='sm:flex sm:items-center sm:justify-between'>
              <div className='flex mt-4 sm:justify-center sm:mt-0'>
                <a
                  href='#'
                  className='text-black hover:text-gray-800 dark:hover:text-white ms-5'
                >
